...
ARL.set <- ZZZ #aHow many weeks do you want to go (on average) without false alarm?
...
This is highly seasonal data and unadjusted CUSUM not great. An alternative is to adjust the expected counts using a harmonic. Try to empirically set the K and H thresholds by fiddling around with the 2007-2008 data
